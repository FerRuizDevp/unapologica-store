      ...
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-base-content/65">
              Curated clothing and accessories, styled for everyday confidence.
              Paid orders include priority support; chat with our team and join
              a video call when we share a link.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-base-content/65">
              Built for people who care about honest fits, thoughtful fabrics,
              and human support when it matters.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 space-y-4 border-t border-base-300 pt-6">
          <p className="text-center text-xs text-base-content/50">
            © {new Date().getFullYear()} Unapologica · All prices in USD
          </p>
        </div>
      </div>
    </footer>
